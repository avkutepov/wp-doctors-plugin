...
**Фильтрация:**
- При передаче параметров `specialization` и `city` с id-значениями, Плагин автоматически применяет фильтрацию
- Фильтры не сбрасываются при их пременении и при пагинации**
